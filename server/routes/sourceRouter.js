...
router.post('/create-source', isAuth,hasRole(['Super Admin', 'Developer']), async (req, res) => {
    try {
        ...
        const newSource = new Source({
            name,
            lead_type_id,
            delstatus: delstatus || false // Set delstatus to false by default
        });
...
router.put('/update-source/:sourceId',isAuth,hasRole(['Super Admin', 'Developer']), async (req, res) => {
    try {
...
router.put('/soft-delete-source/:sourceId', isAuth,hasRole(['Super Admin', 'Developer']),  async (req, res) => {
    try {
        const { sourceId } = req.params;
