...
const WhatsAppChat = ({ leadId }) => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            await axios.post(`${process.env.REACT_APP_BASE_URL}/api/whatsup/send-message`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    return (
        <Card body style={{ padding: '5px 5px 0px 5px', backgroundColor: 'white' }} className='card_discussion_chat_boat mutual_background_class'>
            <h5 className='text-center'>
                <RiWhatsappFill style={{ fontSize: '24px', color: '#4fc65a' }} /><span className="mutual_class_color">
                    {rtl === 'true' ? 'دردشة واتساب' : 'WhatsApp Chat'}
                </span>
            </h5>

            <div className="chat-history" style={{ display: 'flex', flexDirection: 'column', height: '100%', maxHeight: '315px', }}>
                <div
                ...
                <div className="chat_text_container_whatsapp" 
                  style={{
                    direction: rtl === 'true' ? 'rtl' : 'ltr', // Adjust text direction based on RTL
                }}
                >
                    <Form.Group controlId="messageTextarea" className="chat_text_message w-100">
                        ...
                        <Form.Control
                            ...
                            placeholder={rtl === 'true' ? 'اكتب رسالتك هنا...' : 'Type your message here...'}
                            ...
                            style={{
                                ...
                                direction: rtl === 'true' ? 'rtl' : 'ltr', // Adjust text direction based on RTL
                                textAlign: rtl === 'true' ? 'right' : 'left', // Align text
                            }}
                        />
                        ...
                        <label
                            ...
                            style={{
                                ...
                                fontSize: '24px',
                                color: '#000',
                                [rtl === 'true' ? 'left' : 'right']: '46px', // Adjust label position for RTL
                                top: '-2px',
                                cursor: 'pointer',
                            }}
                        >
                        ...
                        {file && (
                            <>
                                <div
                                    style={{
                                        position: 'absolute',
                                        [rtl === 'true' ? 'right' : 'left']: 0, // Adjust position for RTL
                                        bottom: '13px',
