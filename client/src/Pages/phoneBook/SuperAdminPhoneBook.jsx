...
import { Button, Container, Table, Form, Spinner, Row, Col } from 'react-bootstrap';
...
import ImportCSVForm from './ImportCSv';
import './phoneBookstyle.css'
import Sidebar from '../../Components/sidebar/Sidebar';

const SuperAdminPhoneBook = () => {
    ...
    //     if (parsedData.role !== 'Super Admin') {
    //         navigate('/')
    //     }
    // }, [navigate])
...
export default SuperAdminPhoneBook;