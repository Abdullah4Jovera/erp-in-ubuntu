...
const UnassignedLead = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(
                `${process.env.REACT_APP_BASE_URL}/api/users/get-users-by-branch/${selectedBranchId}/${product}`
            );
    ...
    const AddUser = async () => {
        ...
        try {
            ...
            await axios.put(
                `${process.env.REACT_APP_BASE_URL}/api/leads/add-multiple-users-to-lead/${leadId}`,
    ...
    const fetchUnassignedLeads = async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `${process.env.REACT_APP_BASE_URL}/api/leads/unassigned-leads/${productId}`,
                {
                    headers: { Authorization: `Bearer ${token}` },
                }
            );
    ...
    return (
        <div>
            ...
            <Modal show={userModal} onHide={() => setUserModal(false)} centered size="md">
                ...
                <Modal.Body>
                    <Form.Group>
                        <Form.Label>{rtl === 'true' ? 'حدد فرعاً' : 'Select Branch'}</Form.Label>
                        <Select
