...
const CeoCommissionDashboard = () => {
    ...
    return (
        <Container className="">
            <div className="dashboard-status-card-container">
                {/* Collected Commission */}
                <Card className="dashboard-card">
                    <Card.Body>
                        <Card.Title className="text-center">Collected Commission</Card.Title>
                        {collectedCommission ? (
                        ...
                        <div style={{ display: "flex", justifyContent: 'center' }}>
                            <Button className='all_common_btn_single_lead' onClick={() => setCollectedModal(true)}>Collected</Button>
                        </div>
                    </Card.Body>
                </Card>
                ...
                <Card className="dashboard-card">
                    <Card.Body>
                        <Card.Title className="text-center">Rejected Commission</Card.Title>
                        {rejectedCommission ? (
                            <div style={{ color: 'white' }}>
                        ...
                        <div style={{ display: "flex", justifyContent: 'center' }}>
                            <Button className='all_common_btn_single_lead' onClick={() => setRejectedModal(true)}>Rejected</Button>
                        </div>
                    </Card.Body>
                </Card>
                ...
                <Card className="dashboard-card">
                    <Card.Body>
                        <Card.Title className="text-center">Operational Commission</Card.Title>
                        ...
                        <div style={{ display: "flex", justifyContent: 'center' }} >
                            <Button className='all_common_btn_single_lead' onClick={() => setAllCommissionOperationalModal(true)}>Commission</Button>
                        </div>
                    </Card.Body>
                </Card>
                ...
                <Card className="dashboard-card">
                    <Card.Body>
                        <Card.Title className="text-center">Company Commission</Card.Title>
