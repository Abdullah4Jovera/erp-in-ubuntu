...
const CeoDashboard = () => {
    ...
    const [selectedBranchId, setSelectedBranchId] = useState(localStorage.getItem('selectedBranchId') || branch[0]?._id || null);
    const [selectedProductId, setSelectedProductId] = useState(localStorage.getItem('selectedProductId') || product[0]._id || null);
    ...
    useEffect(() => {
        ...
        // const branchId = (Array.isArray(branches) && branches.find(b => b.name === defaultBranchName))?._id;
                                ...
                                <div className="">
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ position: 'absolute', left: 0, bottom: 0, zIndex: 1 }}>
                                            {Array.isArray(branch) && branch.length > 1 && (
                                                branch.map((branch) => (
                                                    <Button
                                                        key={branch._id}
                                                            ...
                                                            >
                                                                ...
                                                                <div className='lead_stage_card_main' >
                                                                    {leadsByStage[stage._id] ? (
                                                                        ...
                                                                        <p className='text-center' style={{ color: '#d7aa47' }} >No Leads Available</p>
                                                                    )}
                                                                </div>
